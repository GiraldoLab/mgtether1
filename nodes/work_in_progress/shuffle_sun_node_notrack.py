...
class ShuffleSun:
    ...
    def __init__(self):
        ...
        #########################################
        self.sun_positions = [19, 93, 57, 129]  #sun position in terms of actual LED number 19(135)18, 57(45)56, 93(-45)92, 129(-135)128
        #########################################
...
#######original######
    ...
    #          self.led_strip.set_led(sun_position,(0,8,0)) #original (0,128,0) -lowered brightness
    #          yield sun_position
