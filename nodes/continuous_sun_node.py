...
from basic_led_strip_ros.msg import SunPosition1
...
class ShuffleSun:
    ...
    def __init__(self):
        ...
        rospy.init_node('continuous_sun')
        rospy.on_shutdown(self.sunset)
        self.sun_position_pub = rospy.Publisher('sun_position1', SunPosition1, queue_size=10)
